      ...
      <div class="form-content">
        ...
        <div class="basic-info">
          ...
          <div class="input-field" :class="{ errorInput: $v.clientGroup.$error }">
            <label>Выберете группу клиента*</label>
            <select v-model="clientGroup" :class="{ error: $v.clientGroup.$error }">
              <option value="VIP">VIP</option>
              <option value="hard-clients">Проблемные</option>
              <option value="OMS">ОМС</option>
            </select>
            <div class="error" v-if="!$v.clientGroup.required">Выберете группу клиента</div>
          </div>

          <div class="input-field">
            <label>Выберете врача</label>
        ...
        <div class="personal-document-container">
          ...
          <div class="input-field" :class="{ errorInput: $v.PersonalDocument.$error }">
            <label>Выберете тип документа*</label>
            <select
            ...
            >
              ...
              <option value="certificate">Свидетельсвто о рождении</option>
          ...
          <span class="footnote">* - поля, обязатльные для заполнения</span>
